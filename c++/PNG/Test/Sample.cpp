...
int main(int argc, char* argv[])
{
	...
	::boost::gil::png_read_image("combine/embTest_4040_base_r.png", src1);
	::boost::gil::rgba8_image_t src2;
	::boost::gil::png_read_image("combine/embTest_4040_color1_r.png", src2);
	::boost::gil::rgba8_image_t src3;
	::boost::gil::png_read_image("combine/embTest_4040_color2_r.png", src3);

	// 着色
	std::vector<Color>::iterator firstColor = std::find_if(colorList.begin(), colorList.end(), ::boost::lambda::_1 == "yellow");//argv[3]);
	std::vector<Color>::iterator secondColor = std::find_if(colorList.begin(), colorList.end(), ::boost::lambda::_1 == "blue");//argv[5]);
    ...
    ::boost::gil::png_write_view(firstColor->name + "_colored1.png", view(coloredSrc2));
	...
	::boost::gil::png_write_view(secondColor->name + "_colored2.png", view(coloredSrc3));
