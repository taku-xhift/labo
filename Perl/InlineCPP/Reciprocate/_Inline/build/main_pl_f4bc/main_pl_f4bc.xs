...
std::cout << "array[0]->value[0]->value[0]->value[0] = " << reinterpret_cast<const char*>(reinterpret_cast<ReciprocateData*>(reinterpret_cast<ReciprocateData*>(array[0].value[0])->value[0])->value[0]) << std::endl;
...
std::cout << "array[0]->value[0]->value[1]->value[0] = " << reinterpret_cast<const char*>(reinterpret_cast<ReciprocateData*>(reinterpret_cast<ReciprocateData*>(array[0].value[0])->value[0])->value[0]) << std::endl;
...
MODULE = main_pl_f4bc     	PACKAGE = main	
