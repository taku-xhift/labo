 ...
 * contents of main_pl_fb02.xs. Do not edit this file, edit main_pl_fb02.xs instead.
 *
 *	ANY CHANGES MADE HERE WILL BE LOST!
 *
 */

#line 1 "main_pl_fb02.xs"
#include "EXTERN.h"
#include "perl.h"
#include "XSUB.h"
#include "INLINE.h"
...
XS(XS_main_c_func_1)
{
    ...
    {
	SV *	text = ST(0);
#line 27 "main_pl_fb02.xs"
	I32* temp;
#line 40 "main_pl_fb02.c"
#line 29 "main_pl_fb02.xs"
...
XS(XS_main_c_func_2)
{
    ...
    {
	SV *	text = ST(0);
#line 43 "main_pl_fb02.xs"
	I32* temp;
#line 68 "main_pl_fb02.c"
#line 45 "main_pl_fb02.xs"
	temp = PL_markstack_ptr++;
	c_func_2(text);
	if (PL_markstack_ptr != temp) {
          /* truly void, because dXSARGS not invoked */
...
extern "C"
#endif
XS(boot_main_pl_fb02); /* prototype to pass -Wmissing-prototypes */
XS(boot_main_pl_fb02)
{
    dXSARGS;
    char* file = __FILE__;
